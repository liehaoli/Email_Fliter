...
# @File : model.py
# @Project: Douban_Bert
# @CreateTime : 2024/5/14 下午23:23:22
# @Version：V 0.1
'''
模型训练和评估
'''
...
class BiLSTM(nn.Module):
    def __init__(self, drop, hidden_dim, output_dim):
        ...
        self.embedding = BertModel.from_pretrained('hfl/chinese-bert-wwm')
        # 去掉移至gpu
...
def train(batch_size, EPOCHS):
    ...
    model = BiLSTM(drop=0.5, hidden_dim=384, output_dim=2)
